...
//
// dbConfig = new
// PropertyFileUtils(CommonUtils.getFilePath(Constants.ENVIRONMENT_PROPERTIES_PATH,
...
// String sqlConnInstance =
// dbConfig.getDataFromPropertyFile("sql_host")+":"+dbConfig.getDataFromPropertyFile("sql_port")+":"+dbConfig.getDataFromPropertyFile("sql_sid");
//
// conUrl = sqlConnDriver+":@"+sqlConnInstance;
// }catch(Exception e)
// {
// throw new RuntimeException("Failed: to frame Connection URL for SQL
// "+e.getMessage());
// }
// return conUrl;
// }
...
// String mySqlConnInstance =
// dbConfig.getDataFromPropertyFile("mysql_host")+":"+dbConfig.getDataFromPropertyFile("mysql_port")+"/"+dbConfig.getDataFromPropertyFile("mysql_sid");
//
// conUrl = mySqlConnDriver+"://"+mySqlConnInstance;
// }catch(Exception e)
// {
// throw new RuntimeException("Failed: to frame Connection URL for MySQL
// "+e.getMessage());
// }
// return conUrl;
// }
...
// try
// {
// String mySqlConnUserName =
// dbConfig.getDataFromPropertyFile("mysql_UserName");
// String mySqlConnPassword =
// dbConfig.getDataFromPropertyFile("mysql_Password");
//
// Class.forName("com.mysql.jdbc.Driver");
// Connection connection = DriverManager.getConnection(connMySQLUrl(),
// mySqlConnUserName, mySqlConnPassword);
...
// }catch(Exception e)
// {
// throw new RuntimeException("Failed: to update data for MySQL
// "+e.getMessage());
// }
//
// return rsUpdate;
