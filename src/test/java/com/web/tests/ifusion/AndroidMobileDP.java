...
public class AndroidMobileDP extends DataInjection {

	Logger logger = LogManager.getLogger(AndroidMobileDP.class.getName());
	...
	public AndroidMobileDP(String orPath, String tdPath, String configPath, String datarows) {

		super(orPath, tdPath, configPath);
		this.sheetName = "AndroidMobile";
	...
	public static Object[][] createDP(String datarows) {
		...
		for (String dataRow : datarowsArray) {
			...
			xx[i][0] = new AndroidMobileDP(orPath, tdPath, configPath, dataRow);
			i++;
		}
