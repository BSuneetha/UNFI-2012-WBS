...
public class MyProfile extends PageActionUtils {

	Logger logger = LogManager.getLogger(MyProfile.class.getName());

	/** Click on MyProfile menu */

	public void navigateMyProfile(MyProfileDP dp, WebDriver driver) {
		try {
