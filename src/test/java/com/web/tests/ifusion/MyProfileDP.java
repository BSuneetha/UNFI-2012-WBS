...
public class MyProfileDP extends DataInjection {
	
	Logger logger = LogManager.getLogger(MyProfileDP.class.getName());
	...
	public MyProfileDP(String orPath, String tdPath, String configPath, String datarows) {

		super(orPath, tdPath, configPath);
		this.sheetName = "MyProfile";
	...
	public static Object[][] createDP(String datarows) {
		...
		for (String dataRow : datarowsArray) {
			...
			xx[i][0] = new MyProfileDP(orPath, tdPath, configPath, dataRow);
			i++;
		}
