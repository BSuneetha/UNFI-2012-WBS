...
public class MySpaceLoginDP extends DataInjection{
	
	Logger logger = LogManager.getLogger(MySpaceLoginDP.class.getName());
	...
	public MySpaceLoginDP(String orPath, String tdPath, String configPath, String datarows) {
		super(orPath, tdPath, configPath);
		this.sheetName = "MySpace";
	...
	public static Object[][] createDP(String datarows) {
		...
		for (String dataRow : datarowsArray) {
			...
			xx[i][0] = new MySpaceLoginDP(orPath, tdPath, configPath, dataRow);
		}
		return xx;
