...
public class ItemSearchDP extends DataInjection {
	
	Logger logger = LogManager.getLogger(ItemSearchDP.class.getName());
	...
	public ItemSearchDP(String orPath, String tdPath, String configPath, String datarows) {

		super(orPath, tdPath, configPath);
		this.sheetName = "ItemSearch";
	...
	public static Object[][] createDP(String datarows) {
		...
		String orPath = Constants.WEB_OBJECT_REPO_FILE_PATH + "Web_Unfi_OR.xls";
		String tdPath = Constants.TESTDATA_FILE_PATH + "TestData_Unfi.xlsx";
		String configPath = Constants.ENVIRONMENT_PROPERTIES_PATH + "web_unfi.properties";
		...
		for (String dataRow : datarowsArray) {
			...
			xx[i][0] = new ItemSearchDP(orPath, tdPath, configPath, dataRow);
			i++;
		}
