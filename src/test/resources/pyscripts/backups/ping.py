...
sys.path.insert(0,"D:/streamlined/HarmonyCoreiFusion/target/test-classes/")
...
input_file= "D:/streamlined/HarmonyCoreiFusion/src/test/resources/pyscripts/config.txt"
